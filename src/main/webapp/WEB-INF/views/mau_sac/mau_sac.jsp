...
<div class="container-fluid">
    ...
    <form:form action="/mau-sac/add" method="post" modelAttribute="tk">
        <div class="col-6">
            <label>Ma</label>
            <form:input type="text" class="form-control" path="maMauSac"/>
            <form:errors path="maMauSac"/>
        </div>
        <div class="col-6">
            <label> Tên </label>
            <form:input type="text" class="form-control" path="tenMauSac"/>
    ...
    <table class="table table-success table-striped">
        ...
        <tbdoy>
            <c:forEach items="${listMauSac}" var="sp">
                <tr>
                    ...
                    <td>
                        <a href="/mau-sac/delete/${sp.maMauSac}" class="btn btn-primary">Xoa</a>
                        <a href="/mau-sac/detail/${sp.maMauSac}" class="btn btn-primary">Update</a>
